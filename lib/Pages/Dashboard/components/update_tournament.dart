...
class Updatetournament extends StatefulWidget {
  @override
  _UpdatetournamentState createState() => _UpdatetournamentState();
}

class _UpdatetournamentState extends State<Updatetournament> {
